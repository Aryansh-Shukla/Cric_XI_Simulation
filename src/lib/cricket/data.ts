...
const india2011: Squad = makeSquad("India 2011", "India", 2011, "ODI_WC", [
  p(
    ...
    "India",
    "Wicketkeeper",
    { batting: 92, leadership: 98, pressure: 97, consistency: 90 },
    ["Captain Fantastic", "Finisher", "Ice Veins"],
    { isCaptain: true },
  ),
  p("Sachin Tendulkar", "India", "Batsman", { batting: 98, consistency: 96, pressure: 92 }, [
    "Run Machine",
    "Big Match Player",
  ]),
  p("Virat Kohli", "India", "Batsman", { batting: 90, consistency: 88, pressure: 88 }, [
    "Run Machine",
  ]),
  p("Yuvraj Singh", "India", "AllRounder", { batting: 88, bowling: 74, pressure: 94 }, [
    "Big Match Player",
    "Clutch Performer",
  ]),
  p("Gautam Gambhir", "India", "Batsman", { batting: 86, pressure: 90 }, ["Wall"]),
  p("Zaheer Khan", "India", "PaceBowler", { bowling: 90, pressure: 88 }, [
    "Strike Bowler",
    "Big Match Player",
  ]),
  ...
  p("Suresh Raina", "India", "AllRounder", { batting: 80, bowling: 66, fielding: 90 }, [
    "Finisher",
  ]),
...
const australia2003: Squad = makeSquad("Australia 2003", "Australia", 2003, "ODI_WC", [
  p(
    ...
    "Australia",
    "Batsman",
    { batting: 96, leadership: 94, consistency: 92 },
    ["Captain Fantastic", "Big Match Player"],
    { isCaptain: true },
  ),
  p("Adam Gilchrist", "Australia", "Wicketkeeper", { batting: 94, pressure: 88 }, [
    "Powerplay Destroyer",
  ]),
  p("Matthew Hayden", "Australia", "Batsman", { batting: 92 }, ["Powerplay Destroyer"]),
  p("Damien Martyn", "Australia", "Batsman", { batting: 86 }),
  p("Michael Bevan", "Australia", "Batsman", { batting: 88, pressure: 94 }, [
    "Finisher",
    "Ice Veins",
  ]),
  p("Andrew Symonds", "Australia", "AllRounder", { batting: 84, bowling: 72, fielding: 92 }),
  p("Glenn McGrath", "Australia", "PaceBowler", { bowling: 96, consistency: 96 }, [
    "Strike Bowler",
    "Wall",
  ]),
...
const australia1999: Squad = makeSquad("Australia 1999", "Australia", 1999, "ODI_WC", [
  p(
    ...
    "Australia",
    "Batsman",
    { batting: 88, leadership: 96, pressure: 96 },
    ["Captain Fantastic", "Ice Veins"],
    { isCaptain: true },
  ),
  p("Mark Waugh", "Australia", "Batsman", { batting: 88, fielding: 90 }),
  p("Shane Warne", "Australia", "SpinBowler", { bowling: 96, pressure: 94 }, [
    "Spin Wizard",
    "Big Match Player",
    "Strike Bowler",
  ]),
...
const england2019: Squad = makeSquad("England 2019", "England", 2019, "ODI_WC", [
  p("Eoin Morgan", "England", "Batsman", { batting: 84, leadership: 92 }, ["Captain Fantastic"], {
    isCaptain: true,
  }),
  p("Ben Stokes", "England", "AllRounder", { batting: 90, bowling: 82, pressure: 96 }, [
    "Clutch Performer",
    "Ice Veins",
    "Big Match Player",
  ]),
  ...
  p("Jofra Archer", "England", "PaceBowler", { bowling: 90, pressure: 90 }, [
    "Strike Bowler",
...
const pakistan1992: Squad = makeSquad("Pakistan 1992", "Pakistan", 1992, "ODI_WC", [
  p(
    ...
    "Pakistan",
    "AllRounder",
    { batting: 82, bowling: 90, leadership: 98, pressure: 94 },
    ["Captain Fantastic", "Big Match Player"],
    { isCaptain: true },
  ),
  p("Wasim Akram", "Pakistan", "PaceBowler", { bowling: 96, batting: 66 }, [
    "Strike Bowler",
    "Death Overs Specialist",
  ]),
...
const westindies1979: Squad = makeSquad("West Indies 1979", "West Indies", 1979, "ODI_WC", [
  p(
    ...
    "West Indies",
    "Batsman",
    { batting: 86, leadership: 94 },
    ["Captain Fantastic"],
    { isCaptain: true },
  ),
  p("Viv Richards", "West Indies", "Batsman", { batting: 96, pressure: 94 }, [
    "Run Machine",
    "Big Match Player",
  ]),
...
const india2007T20: Squad = makeSquad("India 2007", "India", 2007, "T20_WC", [
  p(
    ...
    "India",
    "Wicketkeeper",
    { batting: 88, leadership: 94, pressure: 94 },
    ["Captain Fantastic", "Finisher"],
    { isCaptain: true },
  ),
  p("Yuvraj Singh", "India", "AllRounder", { batting: 92, bowling: 72, pressure: 92 }, [
    "Powerplay Destroyer",
    "Clutch Performer",
  ]),
...
const westindies2016: Squad = makeSquad("West Indies 2016", "West Indies", 2016, "T20_WC", [
  p(
    ...
    "West Indies",
    "AllRounder",
    { batting: 70, bowling: 72, leadership: 92 },
    ["Captain Fantastic"],
    { isCaptain: true },
  ),
  p("Chris Gayle", "West Indies", "Batsman", { batting: 96 }, [
    "Powerplay Destroyer",
    "Run Machine",
  ]),
  p("Marlon Samuels", "West Indies", "Batsman", { batting: 84, pressure: 90 }, [
    "Big Match Player",
  ]),
  p("Andre Russell", "West Indies", "AllRounder", { batting: 90, bowling: 84 }, [
    "Finisher",
    "Death Overs Specialist",
  ]),
  p("Dwayne Bravo", "West Indies", "AllRounder", { batting: 78, bowling: 82 }, [
    "Death Overs Specialist",
  ]),
  p("Carlos Brathwaite", "West Indies", "AllRounder", { batting: 78, bowling: 78, pressure: 92 }, [
    "Clutch Performer",
    "Finisher",
  ]),
...
const australia2021T20: Squad = makeSquad("Australia 2021", "Australia", 2021, "T20_WC", [
  p("Aaron Finch", "Australia", "Batsman", { batting: 84, leadership: 86 }, ["Captain Fantastic"], {
    isCaptain: true,
  }),
  p("David Warner", "Australia", "Batsman", { batting: 92 }, ["Powerplay Destroyer"]),
  p("Mitchell Marsh", "Australia", "AllRounder", { batting: 82, bowling: 70, pressure: 88 }, [
    "Big Match Player",
  ]),
  ...
  p("Matthew Wade", "Australia", "Wicketkeeper", { batting: 78, pressure: 90 }, [
    "Clutch Performer",
  ]),
  p("Pat Cummins", "Australia", "PaceBowler", { bowling: 90 }, ["Strike Bowler"]),
  p("Mitchell Starc", "Australia", "PaceBowler", { bowling: 92 }, [
    "Strike Bowler",
    "Death Overs Specialist",
  ]),
...
const pakistan2017: Squad = makeSquad("Pakistan 2017", "Pakistan", 2017, "CHAMPIONS", [
  p(
    ...
    "Pakistan",
    "Wicketkeeper",
    { batting: 78, leadership: 84 },
    ["Captain Fantastic"],
    { isCaptain: true },
  ),
  p("Fakhar Zaman", "Pakistan", "Batsman", { batting: 86, pressure: 88 }, [
    "Powerplay Destroyer",
    "Big Match Player",
  ]),
  p("Babar Azam", "Pakistan", "Batsman", { batting: 90, consistency: 92 }, ["Run Machine", "Wall"]),
  p("Mohammad Amir", "Pakistan", "PaceBowler", { bowling: 90, pressure: 90 }, [
    "Strike Bowler",
    "Big Match Player",
  ]),
...
const india2013: Squad = makeSquad("India 2013", "India", 2013, "CHAMPIONS", [
  p(
    ...
    "India",
    "Wicketkeeper",
    { batting: 90, leadership: 96 },
    ["Captain Fantastic", "Finisher"],
    { isCaptain: true },
  ),
  p("Shikhar Dhawan", "India", "Batsman", { batting: 88, pressure: 88 }, [
    "Powerplay Destroyer",
    "Big Match Player",
  ]),
  ...
  p("Ravindra Jadeja", "India", "AllRounder", { batting: 76, bowling: 86, fielding: 96 }, [
    "Spin Wizard",
  ]),
...
const chennaiKings: Squad = makeSquad("Chennai Kings 2023", "Franchise", 2023, "FRANCHISE_T20", [
  p(
    ...
    "India",
    "Wicketkeeper",
    { batting: 86, leadership: 96, pressure: 94 },
    ["Captain Fantastic", "Finisher"],
    { isCaptain: true },
  ),
  p("Ruturaj Gaikwad", "India", "Batsman", { batting: 84 }, ["Run Machine"]),
  p("Devon Conway", "New Zealand", "Batsman", { batting: 86, consistency: 90 }, ["Wall"], {
    isOverseas: true,
  }),
  p("Ravindra Jadeja", "India", "AllRounder", { batting: 78, bowling: 84, fielding: 96 }, [
    "Spin Wizard",
  ]),
  ...
  p("Matheesha Pathirana", "Sri Lanka", "PaceBowler", { bowling: 84 }, ["Death Overs Specialist"], {
    isOverseas: true,
  }),
  p("Tushar Deshpande", "India", "PaceBowler", { bowling: 76 }),
  p("Maheesh Theekshana", "Sri Lanka", "SpinBowler", { bowling: 84 }, ["Spin Wizard"], {
    isOverseas: true,
  }),
...
const mumbaiTitans: Squad = makeSquad("Mumbai Titans 2020", "Franchise", 2020, "FRANCHISE_T20", [
  p(
    ...
    "India",
    "Batsman",
    { batting: 90, leadership: 92 },
    ["Captain Fantastic", "Run Machine"],
    { isCaptain: true },
  ),
  p("Quinton de Kock", "South Africa", "Wicketkeeper", { batting: 88 }, ["Powerplay Destroyer"], {
    isOverseas: true,
  }),
  ...
  p(
    ...
    "West Indies",
    "AllRounder",
    { batting: 84, bowling: 72, pressure: 90 },
    ["Finisher", "Clutch Performer"],
    { isOverseas: true },
  ),
  p("Krunal Pandya", "India", "AllRounder", { batting: 72, bowling: 78 }),
  p("Jasprit Bumrah", "India", "PaceBowler", { bowling: 96, pressure: 94 }, [
    "Strike Bowler",
    "Death Overs Specialist",
    "Ice Veins",
  ]),
  p("Trent Boult", "New Zealand", "PaceBowler", { bowling: 90 }, ["Strike Bowler"], {
    isOverseas: true,
  }),
...
const india2023: Squad = gen("India 2023", "India", 2023, "ODI_WC", "Rohit Sharma", [
  [
    "Rohit Sharma",
    "Batsman",
    { batting: 92, leadership: 90 },
    ["Captain Fantastic", "Powerplay Destroyer"],
  ],
...
const sa1999: Squad = gen("South Africa 1999", "South Africa", 1999, "ODI_WC", "Hansie Cronje", [
  [
    "Hansie Cronje",
    "AllRounder",
    { batting: 78, bowling: 72, leadership: 90 },
    ["Captain Fantastic"],
  ],
  ...
  [
    "Lance Klusener",
    "AllRounder",
    { batting: 88, bowling: 84, pressure: 94 },
    ["Finisher", "Ice Veins"],
  ],
...
const india2024T20: Squad = gen("India 2024", "India", 2024, "T20_WC", "Rohit Sharma", [
  ...
  [
    "Jasprit Bumrah",
    "PaceBowler",
    { bowling: 98, pressure: 96 },
    ["Strike Bowler", "Ice Veins", "Death Overs Specialist"],
  ],
...
const england2010T20: Squad = gen("England 2010", "England", 2010, "T20_WC", "Paul Collingwood", [
  [
    "Paul Collingwood",
    "AllRounder",
    { batting: 78, bowling: 70, leadership: 86 },
    ["Captain Fantastic"],
  ],
...
const pakistan2009T20: Squad = gen("Pakistan 2009", "Pakistan", 2009, "T20_WC", "Younis Khan", [
  ...
  [
    "Shahid Afridi",
    "AllRounder",
    { batting: 82, bowling: 82, pressure: 88 },
    ["Clutch Performer", "Big Match Player"],
  ],
...
const australia2006CT: Squad = gen(
  "Australia 2006",
  "Australia",
  2006,
  "CHAMPIONS",
...
const rcbFire: Squad = gen(
  "Bangalore Royals 2016",
  "Franchise",
  2016,
  "FRANCHISE_T20",
  "Virat Kohli",
...
const england2005Test: Squad = gen("England 2005", "England", 2005, "TEST", "Michael Vaughan", [
  ...
  [
    "Andrew Flintoff",
    "AllRounder",
    { batting: 84, bowling: 88, pressure: 92 },
    ["Big Match Player"],
  ],
...
export const MODE_LABELS: Record<GameMode, { title: string; subtitle: string; format: string }> = {
  ...
  FRANCHISE_T20: {
    title: "Franchise League",
    subtitle: "Draft heroes. Max 4 overseas.",
    format: "20 Overs",
  },
